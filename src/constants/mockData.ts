...
export const MOCK_HABITS: Habit[] = [
  ...
  },
  {
    ...
    benefits: [
      "Mengurangi emisi CO₂ kendaraan",
      "Menyehatkan jantung & tubuh",
  ...
  },
  {
    ...
    benefits: [
      ...
      "Mengurangi beban tempat pembuangan",
...
export const MOCK_AI_INSIGHTS: AIInsight[] = [
  {
    id: 1,
    icon: "💡",
    text: "Membawa botol sendiri dapat menghemat hingga 170 botol plastik per tahun.",
  },
  {
    id: 2,
    icon: "🚗",
    text: "Berjalan kaki 1 km menghemat sekitar 120 gram emisi CO₂ dibanding naik motor.",
  },
  {
    id: 3,
    icon: "🌱",
    text: "Kombinasi habitmu minggu ini berpotensi menyelamatkan 1 pohon dari pembalakan!",
  },
]
...
export const MOCK_CHAT_MESSAGES: ChatMessage[] = [
  {
    ...
    user_id: MOCK_USER_ID,
    from_role: "ai",
    text: "Halo Vito! 🌿 Saya Eco Coach, siap membantumu membangun gaya hidup ramah lingkungan. Apa yang ingin kamu diskusikan hari ini?",
